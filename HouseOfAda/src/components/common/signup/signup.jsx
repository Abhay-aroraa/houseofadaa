...
const SignUpForm = () => {
  ...
  return (
    <div className="flex justify-center min-h-screen bg-white px-4 pt-[60px]">
      <div className="w-full max-w-[500px] md:max-w-[600px]">
        <h2 className="text-3xl font-light text-center mb-8">SIGN UP</h2>
        ...
        <div className="space-y-6">
          ...
          <div>
            <label className="block mb-2 font-light">Confirm Password</label>
            <input
              type="password"
          ...
          {otpSent && (
            <div>
              <label className="block mb-2 font-light">OTP</label>
              <input
                type="text"
                value={otp}
        ...
        {!otpSent ? (
          <button
            ...
            disabled={sendingOtp}
            className="w-full mt-8 bg-black text-white py-4 rounded text-lg font-light hover:bg-gray-800 transition disabled:opacity-50"
          >
